...
out_file_name = output_path + 'sample_output_window_size_3.csv'

# input_file_name = input_path + 'train_Denson_WINDOW_SIZE_1_61_features_MCC+AUC_elite_9.csv'
# out_file_name = output_path + 'train_Denson_WINDOW_SIZE_1_61_features_MCC+AUC_elite_9_window_size_3.csv'
